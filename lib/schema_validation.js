        ...
        Table.prototype.validate = function (record) {
            ...
            for (var _i = 0, _b = this.columns; _i < _b.length; _i++) {
                ...
                if (value != null && !Schema.validate_type({ value: value, type: col.type })) {
                    throw new Error("Column \"".concat(col.name, "\" is not of valid type (valid type is of ").concat(col.type, ", instead got value ").concat((0, logs_1.value_to_string)(value), " as ").concat((0, logs_1.value_type_as_string)(value), ")"));
                }
            }
            return true;
        };
