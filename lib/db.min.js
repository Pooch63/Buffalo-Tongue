...
var Validation,Schema,safe_1=__importDefault(require("colors/safe"))
...
var e=function(t){this.default=null,this.unique=!1,this.name=t.name,this.type=t.type,null!=t.unique&&(this.unique=t.unique),null!=t.default&&(this.default=t.default),this.validation=t.validation}
t.Row=e
var n=function(){function e(e){var n=e.rows
this.unique_key=null
for(var a=[],o=0,r=n;o<r.length;o++){var i=r[o]
a.push(new t.Row(i))}for(var u={},l=0,s=a;l<s.length;l++){if(null!=u[(i=s[l]).name])throw new Error('Duplicate row "'.concat(i.name,'"'))
...
this.unique_key=i.name}}this.rows=a}return e.prototype.col_exists=function(t){for(var e=0,n=this.rows;e<n.length;e++){if(n[e].name==t)return!0}return!1},e.prototype.validate=function(e){for(var n,a=0,o=this.rows;a<o.length;a++){var r=o[a],i=null!==(n=e[r.name])&&void 0!==n?n:r.default
if(null==i)throw new Error('Unable to insert record -- row "'.concat(r.name,'" was not included, and no default exists.'))
if(!t.validate_type({value:i,type:r.type}))throw new Error('Column "'.concat(r.name,'" is not of valid type (valid type is of ').concat(r.type,", instead got value ").concat(value_to_string(i)," as ").concat(value_type_as_string(i),")"))}return!0},e}()
t.Table=n,t.get_unique_key=function(t,e){return null==e.unique_key?null:t[e.unique_key]}}(Schema||(Schema={}))
...
for(var a in n){var o=e[a],r=n[a]
if("object"!=typeof r)return o==r
if(r.not_eq&&o===r.not_eq)return!1
if(r.eq&&o!==r.eq)return!1
if(r.lt&&!("number"==typeof o&&o<r.lt))return!1
if(r.gt&&!("number"==typeof o&&o>r.gt))return!1
if(r.lte&&!("number"==typeof o&&o<=r.lte))return!1
if(r.gte&&!("number"==typeof o&&o>=r.gte))return!1}return!0},t.prototype.validate=function(e){for(var n=0,a=this.conditions;n<a.length;n++){var o=a[n]
if(o instanceof t){if(!o.validate(e))return!1}else if(!this.validate_against_condition({row:e,condition:o}))return!1}return!0},t}()
function update_row(t,e){for(var n in e){var a=t[n]
null!=a&&(e[n]=a)}}var Errors,Table=function(){function t(t){var e=t.name,n=t.schema
...
for(var o=0,r=this.schema.rows;o<r.length;o++){var i
if("function"==typeof(i=r[o]).validation&&!i.validation(t[i.name]))throw new Error('Custom validation function declared that column "'.concat(i.name,'" was invalid (value was ').concat(value_to_string(t[i.name]),")"))}this.data[null==a?this.data_count:String(a)]=t,this.data_count+=1},t.prototype.each=function(t){for(var e in this.data){if(null!=this.data[e])if(0==t(this.data[e],e))break}},t.prototype.filter=function(t){if(null!=this.schema.unique_key)for(var e in this.data)null!=this.data[e]&&(t(this.data[e],e)||(this.data[e]=null))
else{for(var n={},a=0,o=0;o<this.data_count;o+=1)t(this.data[o],o)||(n[a]=this.data[o],a+=1)
this.data=n,this.data_count=a}},t}()
!function(t){var e=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return __extends(e,t),e}(Error)
...
var Database=function(){function t(){this.tables={},this.create=this.create_table,this.count=this.select_count}return t.prototype.get_table=function(t){if(null==this.tables[t])throw new Errors.Nonexistent_Value('Table "'.concat(t,'" does not exist.'))
...
var n=0
return t.each((function(t){e.validate(t)&&(n+=1)})),n},t.prototype.select_count=function(t,e){return this.select_count_from_table(this.get_table(t),null==e?null:e instanceof QueryCondition?e:new QueryCondition(e))},t.prototype.delete_from_table=function(t,e){t.filter((function(t){return null==e||e.validate(t)}))},t.prototype.delete=function(t,e){this.delete_from_table(this.get_table(t),null==e?null:e instanceof QueryCondition?e:new QueryCondition(e))},t.prototype.select_distinct=function(t,e,n){for(var a="string"==typeof e?[e]:e,o=this.get_table(t),r=0,i=a;r<i.length;r++){var u=i[r]
if(!o.schema.col_exists(u))throw new Errors.Nonexistent_Column('Select distinct requested distinct, nonexistent column "'.concat(u,'"'))}for(var l={},s=0,c=o.schema.rows;s<c.length;s++){u=c[s]
l[u.name]={}}var f=[]
return o.each((function(t,e){for(var n=0,o=a;n<o.length;n++){var r=o[n]
if(null!=l[r][t[r].toString()])return
l[r][t[r].toString()]=t}f.push(t)})),f},t.prototype.update=function(t,e,n){for(var a=this.get_table(t),o=null==n?null:n instanceof QueryCondition?n:new QueryCondition(n),r=0,i=a.schema.rows;r<i.length;r++){var u=i[r]
if(null!=e[u.name]&&!Schema.validate_type({value:e[u.name],type:u.type}))throw new Errors.Bad_Type('Invalid value provided for column in update statement -- "'.concat(u.name,'" is not of valid type (valid type is of ').concat(value_type_as_string(u.type),", instead got value ").concat(value_to_string(e[u.name])," as ").concat(value_type_as_string(e[u.name]),")"))}a.each((function(t){(null==o||o.validate(t))&&update_row(e,t)}))},t}()
